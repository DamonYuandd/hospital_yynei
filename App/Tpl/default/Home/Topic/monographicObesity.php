...
<div class="obesity001"><a name="pop1"></a></div>
<div class="obesity002"><a name="pop2" href="{:U('Diagnosis/index')}" style="width: 250px;
    height: 30px;
    display: block;
    float: left;
    margin: 270px 0 0 900px;"></a></div>
<div class="obesity003"></div>
<div class="obesity004"><a name="pop3"></a></div>
<div class="obesity005"><a name="pop4"></a></div>
<div class="obesity006"><a href="{:U('Feature/index')}#a" style="width:100%;height:100%;display:block"></a></div>
<div class="obesity007" id="pop7">
...
<div class="monographicAside obesityBg">
	<ul class="nav">
		<a href="#pop1" title="什么是肥胖"></a>
		<a href="#pop2" title="肥胖危害"></a>
		<a href="#pop3" title="肥胖误区"></a>
