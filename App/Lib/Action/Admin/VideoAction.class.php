...
class VideoAction extends AdminAction {
	...
	function _uploadVideo($dir=''){
		...
		//$extension_whitelist = array("avi","rmvb","rm","asf","divx","mpg","mpeg","mpe","wmv","mp4","mkv","vob","3gp","flv");	// Allowed file extensions
		$extension_whitelist = array("flv","mp4");	// Allowed file extensions
